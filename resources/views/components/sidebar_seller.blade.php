    ...
    <div class="card-body nav-dash d-flex flex-column text-decoration-none gap-3 ">
        <div class=" nav-2 sidebar-profile d-flex justify-content-start align-items-center py-3  px-3">
            ...
            <div class="nav-link ms-3" href="">
                <p id="username-sidebar" style="font-size: 17px;" class="fw-bold text-light">Rayhan Arya Ardani</p>
        ...
        <a class="nav-link d-flex align-items-center gap-2" href="/historipesananseller"><i class='bx bx-home-alt me-2'></i>
            <p style="font-size: 14px;">Histori Pesanan</p>
        </a>
        <a class="nav-link d-flex align-items-center gap-2" href="/ulasanseller"><i class='bx bx-home-alt me-2'></i>
            <p style="font-size: 14px;">Ulasan</p>
        <a class="nav-link d-flex align-items-center gap-2" href="/profilseller"><i class='bx bx-home-alt me-2'></i>

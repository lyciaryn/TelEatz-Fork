    ...
    <div class="row dash" style="margin-top: 100px;">
        ...
        <div class="col-lg-9 d-flex flex-column gap-3">
            ...
            <div class="card shadow rounded-4 text-center py-4 px-3 d-flex align-items-center">
                <form action="{{ route('seller.profile.changeEmail.update', $profile->id) }}" method="POST" enctype="multipart/form-data" style="width: 100%; max-width: 600px;">
                    @csrf
                    @method('PUT')
                    <div class="mb-4 text-start">
                        <label class="form-label">Email Lama</label>
                        <input type="email" name="oldEmail" class="form-control" placeholder="Email" value="{{ $profile->email }}"readonly>
                    </div>
                    ...
                    <div class="mb-4 text-start">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Konfirmasi Password Untuk Save Email Baru" required>
                    </div>

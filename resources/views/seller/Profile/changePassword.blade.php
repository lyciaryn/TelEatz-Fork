    ...
    <div class="row dash" style="margin-top: 100px;">
        ...
        <div class="col-lg-9 d-flex flex-column gap-3">
            ...
            <div class="card shadow rounded-4 text-center py-4 px-3 d-flex align-items-center">
                <form action="{{ route('seller.profile.changePassword.update', $profile->id) }}" method="POST" enctype="multipart/form-data" style="width: 100%; max-width: 600px;">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4 text-start">
                        ...
                        <input type="password" name="newPassword_confirmation" class="form-control" placeholder="Konfirmasi Password Baru" required>
                    </div>

...
<div class="container">
    <div class="row dash" style="margin-top: 100px;">
        ...
        <div class="col-lg-9 d-flex flex-column gap-3">
            ...
            <form action="{{ route('kelolamakanan.showdetail', $makanan->id) }}" method="GET" enctype="multipart/form-data">
                @csrf
                <div class="card-body card-nothings bg-light p-5 d-flex justify-content-center align-items-center flex-column">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('images/'.$makanan->img) }}" alt="{{ $makanan->nama_product }}" class="img-fluid me-4" style="max-width: 300px; height: auto; border-radius: 20px;">
                        <div>
                            <h1 class="fw-bold fs-4 mt-3" style="color:var(--darkt);">Edit Menu Makanan</h1>
                            <div>
                                <label style="text-align: left;">Nama Makanan</label>
                                <input type="text" class="form-control" size="1000" name="nama_product" value="{{ $makanan->nama_product }}" required disabled>
                            </div>
                            <div>
                                <label style="text-align: left;">Harga</label>
                                <input type="text" class="form-control" size="1000" name="harga" value="{{ $makanan->harga }}" required disabled>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="is_available" class="form-select" aria-label="Pilih kategori" required disabled>
